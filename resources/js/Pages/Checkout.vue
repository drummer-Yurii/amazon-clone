...
onMounted(() => {
    stripe = Stripe("pk_test_51LutNKF5pBtNoeM0YTjgq3bZr67G8EuEsw1uWosVsQFWONk6XJ98EfQQEOYH3JYCDDtTvX8IKQryuM93Eiy2hc7R000neW08az");
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="p-4 mt-2 m-w-[1250px] mx-auto text-3xl font-extrabold">Checkout</div>

        <div class="flex m-w-[1250px] mx-auto pt-4">
            <div class="w-8/12">
